...
namespace NeptuneEVO.Businesses
{
    class BarberShopI : Script
    {
        ...
        public class BarberShop : BCore.Bizness
        {
            ...
            public BarberShop(int id, string owner, Vector3 position, Vector3 matposition, int cost, int mafia, int bankid, int mat, Vector3 infopoint, int ear) : base(id, owner, position, matposition, cost, mafia, bankid, mat, infopoint, ear)
            {
                Type = 10;
                Name = "Парикмахерская";
                BlipColor = 4;
