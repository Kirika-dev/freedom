...
namespace NeptuneEVO.Businesses
{
    ...
    public class BCore : Script
    {
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                foreach (DataRow Row in result.Rows)
                {
                    ...
                    Vector3 infopoint = JsonConvert.DeserializeObject<Vector3>(Row["infobiz"].ToString());
                    ...
                    CreateBusiness(Convert.ToInt32(Row["type"]), Convert.ToInt32(Row["id"]), Row["owner"].ToString(), enterpoint, unloadpoint, Convert.ToInt32(Row["sellprice"]), Convert.ToInt32(Row["mafia"]), Convert.ToInt32(Row["money"]), Convert.ToInt32(Row["materials"]), time, infopoint, Convert.ToInt32(Row["earnings"]));
        ...
        public static void CreateBusiness(int type, int id, string owner, Vector3 enterpoint, Vector3 unloadpoint, int price, int mafia, int bank, int mat, DateTime upg, Vector3 infopoint, int ear)
        {
            NAPI.Task.Run(() => { 
            ...
            switch (type)
            {
                ...
                case 0:
                    data = new ShopI.Shop(id, owner, enterpoint, unloadpoint, price, mafia, bank, mat, infopoint, ear);
                        data.Upgrade = upg;
                        LastID = id;
                    BizList.Add(id, data);
                    break;
                case 1:
                    data = new RefillI.Refill(id, owner, enterpoint, unloadpoint, price, mafia, bank, mat, infopoint, ear);
                        data.Upgrade = upg;
                        LastID = id;
                    BizList.Add(id, data);
                    break;
                case 2:
                    data = new AutoShopI.AutoShopPremium(id, owner, enterpoint, unloadpoint, price, mafia, bank, mat, infopoint, ear);
                        data.Upgrade = upg;
                        LastID = id;
                    BizList.Add(id, data);
                    break;
                case 3:
                    data = new AutoShopI.AutoShopEkonom(id, owner, enterpoint, unloadpoint, price, mafia, bank, mat, infopoint, ear);
                        data.Upgrade = upg;
                        LastID = id;
                    BizList.Add(id, data);
                    break;
                case 4:
                    data = new AutoShopI.AutoShopMiddle(id, owner, enterpoint, unloadpoint, price, mafia, bank, mat, infopoint, ear);
                        data.Upgrade = upg;
                        LastID = id;
                    BizList.Add(id, data);
                    break;
                case 5:
                    data = new AutoShopI.AutoShopMoto(id, owner, enterpoint, unloadpoint, price, mafia, bank, mat, infopoint, ear);
                        data.Upgrade = upg;
                        LastID = id;
                    BizList.Add(id, data);
                    break;
                case 6:
                    data = new GunShopI.GunShop(id, owner, enterpoint, unloadpoint, price, mafia, bank, mat, infopoint, ear);
                        data.Upgrade = upg;
                        LastID = id;
                    BizList.Add(id, data);
                    break;
                case 7:
                    data = new ClothesShopI.PonsonbysClothesShop(id, owner, enterpoint, unloadpoint, price, mafia, bank, mat, infopoint, ear);
                        data.Upgrade = upg;
                        LastID = id;
                    BizList.Add(id, data);
                    break;
                case 8:
                    data = new ShopI.EatShop(id, owner, enterpoint, unloadpoint, price, mafia, bank, mat, infopoint, ear);
                        data.Upgrade = upg;
                        LastID = id;
                    BizList.Add(id, data);
                    break;
                case 9:
                    data = new TattooShopI.TattooShop(id, owner, enterpoint, unloadpoint, price, mafia, bank, mat, infopoint, ear);
                        data.Upgrade = upg;
                        LastID = id;
                    BizList.Add(id, data);
                    break;
                case 10:
                    data = new BarberShopI.BarberShop(id, owner, enterpoint, unloadpoint, price, mafia, bank, mat, infopoint, ear);
                        data.Upgrade = upg;
                        LastID = id;
                    BizList.Add(id, data);
                    break;
                case 11:
                    data = new MaskShopI.MaskShop(id, owner, enterpoint, unloadpoint, price, mafia, bank, mat, infopoint, ear);
                        data.Upgrade = upg;
                        LastID = id;
                    BizList.Add(id, data);
                    break;
                case 12:
                    data = new TuningI.Tuning(id, owner, enterpoint, unloadpoint, price, mafia, bank, mat, infopoint, ear);
                        data.Upgrade = upg;
                        LastID = id;
                    BizList.Add(id, data);
                    break;
                case 13:
                    data = new CarWashI.CarWash(id, owner, enterpoint, unloadpoint, price, mafia, bank, mat, infopoint, ear);
                        data.Upgrade = upg;
                        LastID = id;
                    BizList.Add(id, data);
                    break;
                case 14:
                    data = new PetShopI.PetShop(id, owner, enterpoint, unloadpoint, price, mafia, bank, mat, infopoint, ear);
                        data.Upgrade = upg;
                        LastID = id;
                    BizList.Add(id, data);
                    break;
                case 16:
                    data = new ShopI.SimShop(id, owner, enterpoint, unloadpoint, price, mafia, bank, mat, infopoint, ear);
                        data.Upgrade = upg;
                        LastID = id;
                    BizList.Add(id, data);
                    break;
                case 18:
                    data = new ShopI.HealShop(id, owner, enterpoint, unloadpoint, price, mafia, bank, mat, infopoint, ear);
                        data.Upgrade = upg;
                        LastID = id;
                    BizList.Add(id, data);
                    break;
                case 19:
                    data = new ClothesShopI.BincoClothesShop(id, owner, enterpoint, unloadpoint, price, mafia, bank, mat, infopoint, ear);
                        data.Upgrade = upg;
                        LastID = id;
                    BizList.Add(id, data);
                    break;
                case 20:
                    data = new ClothesShopI.SuburbanClothesShop(id, owner, enterpoint, unloadpoint, price, mafia, bank, mat, infopoint, ear);
                        data.Upgrade = upg;
                        LastID = id;
                    BizList.Add(id, data);
                    break;
                case 21:
                    data = new ClothesShopI.RealClothesShop(id, owner, enterpoint, unloadpoint, price, mafia, bank, mat, infopoint, ear);
                        data.Upgrade = upg;
                        LastID = id;
                    BizList.Add(id, data);
                    break;
                case 22:
                    data = new AutoShopI.AutoShopDonate(id, owner, enterpoint, unloadpoint, price, mafia, bank, mat, infopoint, ear);
                        data.Upgrade = upg;
                        LastID = id;
                    BizList.Add(id, data);
                    break;
                case 23:
                    data = new AutoShopI.AutoShopTrucks(id, owner, enterpoint, unloadpoint, price, mafia, bank, mat, infopoint, ear);
                        data.Upgrade = upg;
                        LastID = id;
                    BizList.Add(id, data);
                    break;
                case 24:
                    data = new BagShopI.BagShop(id, owner, enterpoint, unloadpoint, price, mafia, bank, mat, infopoint, ear);
                    data.Upgrade = upg;
                    LastID = id;
                    BizList.Add(id, data);
                    break;
                case 25:
                    data = new AutoShopI.AirShops(id, owner, enterpoint, unloadpoint, price, mafia, bank, mat, infopoint, ear);
                        data.Upgrade = upg;
                        LastID = id;
                    BizList.Add(id, data);
                    break;
        ...
        public static void CreateBiz(Player player, int price, int type)
        {
            try
            {
                ...
                MySQL.Query($"INSERT INTO businesses (id, owner, sellprice, type, enterpoint, unloadpoint, money, mafia, materials, upgrade) " +
                    $"VALUES ({LastID}, 'Государство', {price}, {type}, '{JsonConvert.SerializeObject(pos)}', '{JsonConvert.SerializeObject(new Vector3())}', {bankID}, -1, '{50000}', '{MySQL.ConvertTime(DateTime.Now)}')");
                CreateBusiness(type, LastID, "Государство", pos, new Vector3(), price, -1, bankID, 1000, DateTime.Now.AddDays(-1), new Vector3(0,0,0), 0);
        ...
        [Command("chpbiz")]
        public static void ChangePosBiz(Player player, int id)
        {
            try
            {
                if (player == null || !Main.Players.ContainsKey(player)) return;
                if (Main.Players[player].AdminLVL < 9) return;
                Bizness biz = BizList[id];
                biz.ChangePos(player);
            }
            catch (Exception e) { Log.Write("EXCEPTION AT \"CMD\":\n" + e.ToString(), nLog.Type.Error); }
        }

        [Command("infobizcol")]
        public static void CMD_CreateInfoBizCol(Player player, int id)
        {
            try
            {
                if (player == null || !Main.Players.ContainsKey(player)) return;
        ...
        [RemoteEvent("server::biz:info:buy")]
        public static void SERVER_BIZ_INFO_BUY(Player player)
        {
            try
            {
                if (player == null || !Main.Players.ContainsKey(player)) return;

                if (!player.HasData("BIZ_INFO_ID") || player.GetData<int>("BIZ_INFO_ID") == -1)
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Вы должны находиться около информации о бизнесе", 3000);
                    return;
                }
                int id = player.GetData<int>("BIZ_INFO_ID");
                Bizness biz = BizList[id];
                if (biz.GetTypes() == 23 || biz.GetTypes() == 26 || biz.Cost == 0) return;
                if (Main.Players[player].BizIDs.Count >= Group.GroupMaxBusinesses[Main.Accounts[player].VipLvl])
                {
                ...
                biz.OpenInfoMenu(player);
            }
            catch (Exception e) { Log.Write("EXCEPTION AT \"CMD\":\n" + e.ToString(), nLog.Type.Error); }
        }

        [RemoteEvent("server::biz:info:sell")]
        public static void SERVER_BIZ_INFO_SELL(Player player)
        {
            try
            {
                if (player == null || !Main.Players.ContainsKey(player)) return;
                ...
                Bizness biz = BizList[player.GetData<int>("BIZ_INFO_ID")];
                biz.Sell(player);
                biz.OpenInfoMenu(player);
            }
            catch (Exception e) { Log.Write("EXCEPTION AT \"CMD\":\n" + e.ToString(), nLog.Type.Error); }
        ...
        public class Bizness
        {
            ...
            public Vector3 InfoPosition { get; set; } = new Vector3();
            ...
            protected float BlipSize { get; set; } = 0.8f;
            ...
            [JsonIgnore]
            private ColShape ShapeInfo;

            public Bizness(int id, string owner, Vector3 position, Vector3 matposition, int cost, int mafia, int bankid, int mat, Vector3 infopoint, int earning)
            {

                try
                {
                    ID = id; Owner = owner; Position = position; MaterialsPosition = matposition; Cost = cost; Mafia = mafia; BankID = bankid; Materials = mat; InfoPosition = infopoint; Earnings = earning;
                    ...
                    ShapeM.OnEntityEnterColShape += (s, entity) =>
                    {
                        try
                        {
                            if (entity.HasData("ORDER_MAT") && entity.GetData<int>("ORDER_MAT") == s.GetData<int>("ORDER_ID"))
                            {
                                ...
                                Trigger.PlayerEvent(entity, "client::showhintHUD", true, "Нажмите чтобы выгрузить товар");
                            }
                        }
            ...
            public void OpenInfoMenu(Player player)
            {
                ...
                bool owner = Owner == player.Name ? true : false;
                List<object> data = new List<object>()
                {
                    ...
                    Cost,          //3
                    Earnings,         //4
                    Fractions.Manager.getName(Mafia) == null ? "Отсутствует" : Fractions.Manager.getName(Mafia), //5
                    GetNalogMaterials() * 6,             //6
                    GetNalog() * 24                         //7
                };
                Trigger.PlayerEvent(player, "client::biz:info:open", JsonConvert.SerializeObject(data), owner);
                return;
            }
            ...
            public void CreateStuff()
            {
                ...
                Blip = NAPI.Blip.CreateBlip(BlipType, Position, BlipSize, Convert.ToByte(BlipColor), Main.StringToU16(Name), 255, 0, true, 0, 0);
                switch(Type)
                {
                    case 1:
                    case 12:
                    case 13:
                        Marker = NAPI.Marker.CreateMarker(1, Position + new Vector3(0, 0, 0.2f), new Vector3(), new Vector3(), 0.5f, new Color(67, 140, 239, 0), false, 0);
                        break;
                    default:
                        Marker = NAPI.Marker.CreateMarker(1, Position + new Vector3(0, 0, 0.2f), new Vector3(), new Vector3(), 0.5f, new Color(67, 140, 239), false, 0);
                        break;
                }
                ...
                Shape = NAPI.ColShape.CreateCylinderColShape(Position, Range, 3.5f, 0);
                ...
                Shape.OnEntityEnterColShape += (s, entity) =>
                {
                    try
                    {
                        ...
                        Trigger.PlayerEvent(entity, "client::showhintHUD", true, Name + " #" + ID);
                    }
                    catch (Exception e) { Console.WriteLine("OnEnter: " + e.Message); }
                };
                ...
                MarkerInfo = NAPI.Marker.CreateMarker(29, new Vector3(InfoPosition.X, InfoPosition.Y, InfoPosition.Z + 0.85), new Vector3(), new Vector3(), 1f, new Color(255, 255, 255, 120), false, 0);
                labelInfo = NAPI.TextLabel.CreateTextLabel(Name + $" [{ID}]", new Vector3(InfoPosition.X, InfoPosition.Y, InfoPosition.Z + 1.4), 5F, 0.5F, 0, new Color(255, 255, 255, 190), true, 0);
                ShapeInfo = NAPI.ColShape.CreateCylinderColShape(InfoPosition - new Vector3(0, 0, 1), 1, 3, 0);
                ShapeInfo.OnEntityEnterColShape += (s, ent) =>
                {
                    try
                    {
                        NAPI.Data.SetEntityData(ent, "BIZ_INFO_ID", ID);
                        NAPI.Data.SetEntityData(ent, "INTERACTIONCHECK", 507);
                        Trigger.PlayerEvent(ent, "client::showhintHUD", true, "Информация о бизнесе");
                    }
                    catch (Exception ex) { Console.WriteLine("shape.OnEntityEnterColShape: " + ex.Message); }
                };
                ShapeInfo.OnEntityExitColShape += (s, ent) =>
                {
                    try
                    {
                        if (NAPI.Entity.GetEntityType(ent) != EntityType.Player) return;
                        NAPI.Data.SetEntityData(ent, "INTERACTIONCHECK", 0);
                        NAPI.Data.ResetEntityData(ent, "BIZ_INFO_ID");
            ...
            public void ChangePos(Player player)
            {
                NAPI.Task.Run(() =>
                {
                    var pos = player.Position; pos.Z -= 1.12F;
                    Position = pos;
                    MySQL.Query($"UPDATE businesses SET enterpoint='{JsonConvert.SerializeObject(Position)}' WHERE id='{ID}'");
                });
            }

            public void CreateInfoBizCol(Player player)
            {
                NAPI.Task.Run(() =>
                {
                    var pos = player.Position; pos.Z -= 1.12F;
                    InfoPosition = pos;
                    MySQL.Query($"UPDATE businesses SET infobiz='{JsonConvert.SerializeObject(InfoPosition)}' WHERE id='{ID}'");
                });
                if (MarkerInfo != null)
                    MarkerInfo.Delete();
                if (labelInfo != null)
            ...
            public void UpdateLabel()
            {
                NAPI.Task.Run(() => { 
                    try { 
                        string text = $"~g~ID:~w~{ID}\n";
                        if (Type == 1)
                            text += $"~g~Литр:~w~{RefillI.CostForFuel}$\n";
                        Label.Text = text;
                    }
                    catch (Exception e) { Log.Write("ERROR: " + e.ToString(), nLog.Type.Error); }
                });
            ...
            {
                try { 
                    return nInventory.InventoryItems.Find(x => x.Name == name).ItemType;
                }
        ...
        static void SendBiz(Player player, int index)
        {
            try
            {
                ...
                if (Main.Players[player].BizIDs[index] == Convert.ToInt32(null)) return;
