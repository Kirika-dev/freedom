...
namespace NeptuneEVO.Businesses
{
    class ClothesShopI : Script
    {
        ...
        public class RealClothesShop : BCore.Bizness
        {
            public static int CostForClothes = 1;
            public RealClothesShop(int id, string owner, Vector3 position, Vector3 matposition, int cost, int mafia, int bankid, int mat, Vector3 infopoint, int ear) : base(id, owner, position, matposition, cost, mafia, bankid, mat, infopoint, ear)
            {
                Type = 21;
                Name = "Магазин одежды";
                BlipColor = 4;
            ...
            public override void InteractPress(Player player)
            {
                ...
                Trigger.PlayerEvent(player, "openClothes", CostForClothes, 1);
        ...
        public class BincoClothesShop : BCore.Bizness
        {
            public static int CostForClothes = 1;
            public BincoClothesShop(int id, string owner, Vector3 position, Vector3 matposition, int cost, int mafia, int bankid, int mat, Vector3 infopoint, int ear) : base(id, owner, position, matposition, cost, mafia, bankid, mat, infopoint, ear)
            {
                Type = 19;
                Name = "Магазин одежды";
                BlipColor = 4;
            ...
            {
                if (!Main.Players.ContainsKey(player)) return;
                Trigger.PlayerEvent(player, "openClothes", CostForClothes, 2);
                player.PlayAnimation("amb@world_human_guard_patrol@male@base", "base", 1);
                NAPI.Entity.SetEntityDimension(player, Dimensions.RequestPrivateDimension(player));
            }
        }
        public class SuburbanClothesShop : BCore.Bizness
        {
            public static int CostForClothes = 1;
            public SuburbanClothesShop(int id, string owner, Vector3 position, Vector3 matposition, int cost, int mafia, int bankid, int mat, Vector3 infopoint, int ear) : base(id, owner, position, matposition, cost, mafia, bankid, mat, infopoint, ear)
            {
                Type = 20;
                Name = "Магазин одежды";
                BlipColor = 4;
            ...
            {
                if (!Main.Players.ContainsKey(player)) return;
                Trigger.PlayerEvent(player, "openClothes", CostForClothes, 3);
                player.PlayAnimation("amb@world_human_guard_patrol@male@base", "base", 1);
                NAPI.Entity.SetEntityDimension(player, Dimensions.RequestPrivateDimension(player));
            }
        }
        public class PonsonbysClothesShop : BCore.Bizness
        {
            public static int CostForClothes = 1;

            public PonsonbysClothesShop(int id, string owner, Vector3 position, Vector3 matposition, int cost, int mafia, int bankid, int mat, Vector3 infopoint, int ear) : base(id, owner, position, matposition, cost, mafia, bankid, mat, infopoint, ear)
            {
                Type = 7;
                Name = "Магазин одежды";
                BlipColor = 4;
            ...
            {
                if (!Main.Players.ContainsKey(player)) return;
                Trigger.PlayerEvent(player, "openClothes", CostForClothes, 0);
                player.PlayAnimation("amb@world_human_guard_patrol@male@base", "base", 1);
                NAPI.Entity.SetEntityDimension(player, Dimensions.RequestPrivateDimension(player));
            }
                ...
                public static void Buy(Player player, int type, int variation, int texture)
                {
                    try
                    {
                        ...
                        var price = Convert.ToInt32((tempPrice / 100.0) * PonsonbysClothesShop.CostForClothes);
                        ...
                        BattlePass.AddProgressToQuest(player, 21, 1);
                    }
            ...
            public static void Cancel(Player player)
            {
                try
                {
                    PonsonbysClothesShop.Cancel(player);
                }
            ...
            public static void Buy(Player player, int type, int variation, int texture)
            {
                try
                {
                    PonsonbysClothesShop.Buy(player, type, variation, texture);
                }
                catch (Exception e) { Log.Write(e.ToString(), nLog.Type.Error); }
            }
        }
