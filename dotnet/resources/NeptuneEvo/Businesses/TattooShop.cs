...
namespace NeptuneEVO.Businesses
{
    class TattooShopI : Script
    {
        ...
        public class TattooShop : BCore.Bizness
        {
            ...
            public TattooShop(int id, string owner, Vector3 position, Vector3 matposition, int cost, int mafia, int bankid, int mat, Vector3 infopoint, int ear) : base(id, owner, position, matposition, cost, mafia, bankid, mat, infopoint, ear)
            {
                Type = 9;
                Name = "Тату-Салон";
                BlipColor = 4;
