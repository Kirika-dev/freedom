...
namespace NeptuneEVO.Entertainment
{
    ...
    public class GunGame : Script
    {
        ...
        static int LastID = -1;
        public static Vector3 pos = new Vector3(-268.23242, -2031.9342, 29.025599);
        ...
        public void CreateGunGame()
        {
            try
            {
                ...
                NAPI.Blip.CreateBlip(673, new Vector3(-254.79948, -2026.8092, 29.021372), 0.9f, 4, Main.StringToU16("Maze Bank Arena"), 255, 0, true, 0, 0);
                ...
                NAPI.Marker.CreateMarker(1, pos - new Vector3(0, 0, 0), new Vector3(), new Vector3(), 2.965f, new Color(13, 230, 70, 220), false, 0);
                NAPI.Marker.CreateMarker(27, pos + new Vector3(0, 0, 0.14f), new Vector3(), new Vector3(), 3f, new Color(13, 230, 70, 220), false, 0);
        ...
        static List<string> WeaponOnIndex = new List<string> { "Revolver", "SMG", "Rifle", "Heavy Shotgun" };
        public static Dictionary<string, int> WeaponOnName = new Dictionary<string, int> { { "Revolver", -1045183535 }, { "SMG", 736523883 }, { "Rifle", -1074790547 }, { "Heavy Shotgun", 984333226 } };
