...
namespace NeptuneEVO.Jobs
{
    class Diver : Script
    {
        ...
        private static int checkpointPayment = rand.Next(10000, 16000);
            ...
            try
            {
                ...
                else
                {
                   /* item = new nItem(ItemType.Iron);
                    ...
                    Utilis.QuestsManager.AddQuestProcess(player, 3);     */
               ...
               /* Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, $"Вы собрали {nInventory.InventoryItems.Find(x => x.ID == item.ID).Name}", 3000);   */
