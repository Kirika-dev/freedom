...
namespace NeptuneEVO.Fractions
{
    class Police : Script
    {
        ...
        {
            new Vector3(484.76602, -1008.8155, 26.153225), // метка возле камеры       0 ------todo
            new Vector3(484.15015, -1001.7343, 24.614647), // guns     1 ------OK
            new Vector3(473.37747, -987.8576, 24.614647), // переодевалка     2 ------OK
            new Vector3(475.19672, -1008.26025, 33.0971), // режим ЧС     3 ------OK
            new Vector3(-167.03365, -1151.2672, 23.402315), // корды спавна в камере   4  ------todo
            new Vector3(426.7573, -978.76355, 29.590015), // место спавна из тюрьмы     5 ------todo
            new Vector3(0,0,0), // buy gun licence     6 ------OK
            new Vector3(441.5873, -984.17944, 29.56932), // сдать сумку    7 ------OK
            new Vector3(484.92123, -1006.69324, 24.614565),  // открыть склад     8 ------OK
            new Vector3(456.39005, -976.6982, 24.609682),  // ускорение авто       9 ------OK
			
			//ТЮРЬМА
			new Vector3(449.0943, -985.875, 33.08131), // метка возле камеры       0 / 10 OK
			new Vector3(450.10928, -980.39465, 33.09415), // корды спавна в камере  4 / 11 OK
			new Vector3(426.17114, -976.3408, 30.59056), // место спавна из тюрьмы     5 /12 OK
            //ШТРАФ СТОЯНКА
            ...
            //КОМПЬЮТЕР
            new Vector3(449.89517, -987.1086, 29.569344), // включить комп
        };
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Выдача оружия"), new Vector3(policeCheckpoints[1].X, policeCheckpoints[1].Y, policeCheckpoints[1].Z + 0.7), 5F, 0.3F, 4, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Раздевалка"), new Vector3(policeCheckpoints[2].X, policeCheckpoints[2].Y, policeCheckpoints[2].Z + 0.7), 5F, 0.3F, 4, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~o~Режим ЧС"), new Vector3(policeCheckpoints[3].X, policeCheckpoints[3].Y, policeCheckpoints[3].Z + 0.7), 5F, 0.3F, 4, new Color(255, 255, 255));
                ...
                //NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Сдать награбленное"), new Vector3(policeCheckpoints[7].X, policeCheckpoints[7].Y, policeCheckpoints[7].Z + 0.7), 5F, 0.3F, 4, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Склад оружия"), new Vector3(policeCheckpoints[8].X, policeCheckpoints[8].Y, policeCheckpoints[8].Z + 0.7), 5F, 0.3F, 4, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Тюнинг авто"), new Vector3(policeCheckpoints[9].X, policeCheckpoints[9].Y, policeCheckpoints[9].Z + 0.7), 5F, 0.3F, 4, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel("~h~~w~Штрафстоянка", new Vector3(policeCheckpoints[13].X, policeCheckpoints[13].Y, policeCheckpoints[13].Z + 1f), 5F, 0.5F, 4, new Color(255, 255, 255), true, 0);
                ...
                NAPI.TextLabel.CreateTextLabel("~h~~w~Поставить на Штрафстоянку", new Vector3(policeCheckpoints[14].X, policeCheckpoints[14].Y, policeCheckpoints[14].Z + 1f), 5F, 0.5F, 4, new Color(255, 255, 255), true, 0);
                ...
                NAPI.TextLabel.CreateTextLabel("~h~~w~Проверка по базе", new Vector3(policeCheckpoints[15].X, policeCheckpoints[15].Y, policeCheckpoints[15].Z + 1f), 5F, 0.5F, 4, new Color(255, 255, 255), true, 0);

                NAPI.Marker.CreateMarker(1, policeCheckpoints[1] - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 0.5f, new Color(217, 207, 255));
                NAPI.Marker.CreateMarker(1, policeCheckpoints[2] - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 0.5f, new Color(217, 207, 255));
                NAPI.Marker.CreateMarker(1, policeCheckpoints[3] - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 0.5f, new Color(217, 207, 255));
                NAPI.Marker.CreateMarker(1, policeCheckpoints[7], new Vector3(), new Vector3(), 0.5f, new Color(217, 207, 255));
                NAPI.Marker.CreateMarker(1, policeCheckpoints[8] - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 0.5f, new Color(217, 207, 255));
                NAPI.Marker.CreateMarker(1, policeCheckpoints[9] - new Vector3(0, 0, 3.7), new Vector3(), new Vector3(), 2f, new Color(217, 207, 255));
				NAPI.Marker.CreateMarker(1, policeCheckpoints[10] - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 0.5f, new Color(217, 207, 255));

                NAPI.Marker.CreateMarker(1, policeCheckpoints[14] - new Vector3(0, 0, 2f), new Vector3(), new Vector3(), 2.965f, new Color(217, 207, 255), false, 0);
                NAPI.Marker.CreateMarker(27, policeCheckpoints[14] + new Vector3(0, 0, 0.14f), new Vector3(), new Vector3(), 3f, new Color(217, 207, 255), false, 0);

                NAPI.Marker.CreateMarker(1, policeCheckpoints[15], new Vector3(), new Vector3(), 0.965f, new Color(217, 207, 255), false, 0);
                NAPI.Marker.CreateMarker(27, policeCheckpoints[15] + new Vector3(0, 0, 0.14f), new Vector3(), new Vector3(), 1f, new Color(217, 207, 255), false, 0);

                NAPI.Blip.CreateBlip(636, policeCheckpoints[13], 0.7f, 38, Main.StringToU16("Штрафстоянка"), 255, 0, true, 0, 0);
                NAPI.Marker.CreateMarker(1, policeCheckpoints[13] - new Vector3(0, 0, 0.5f), new Vector3(), new Vector3(), 0.965f, new Color(217, 207, 255), false, 0);
                NAPI.Marker.CreateMarker(27, policeCheckpoints[13] + new Vector3(0, 0, 0.14f), new Vector3(), new Vector3(), 1f, new Color(217, 207, 255), false, 0);
        ...
        public static void callPolice(Player player, string reason)
        {
            NAPI.Task.Run(() =>
            {
                try
                {
                    ...
                    Manager.sendFractionMessage(7, $"~o~Поступил вызов от гражданина ({player.Value}) - {reason}", true);
                    Manager.sendFractionMessage(9, $"Поступил вызов от гражданинка ({player.Value}) - {reason}");
                    Manager.sendFractionMessage(9, $"~o~Поступил вызов от гражданина ({player.Value}) - {reason}", true);
                }
                catch { }
            });
        }
        ...
        public static void acceptCall(Player player, Player target)
        {
            try
            {
                ...
                Manager.sendFractionMessage(7, $"~o~{player.Name.Replace('_', ' ')} принял вызов от гражданина ({target.Value})", true);
        ...
        public static void checkNumber(Player sender, params object[] arguments)
        {
            try
            {
                ...
                Trigger.PlayerEvent(sender, "executeCarInfo", Convert.ToString(Utilis.VehiclesName.GetRealVehicleName( vehicle.Model )), vehicle.Holder.Replace('_', ' ') + ( VehicleManager.HavePlactic(number) ? " [Имеется пластик]" : " [Нет пластика]"));
            }
        ...
        public static void checkPerson(Player sender, params object[] arguments)
        {
            try
            {
                ...
                catch
                {
                    ...
                    cmd.CommandText = "SELECT * FROM characters WHERE firstname=@firstname AND lastname=@lastname";
                    cmd.Parameters.AddWithValue("@login", split[0]);
                    cmd.Parameters.AddWithValue("@password", split[1]);
        ...
        public static void interactPressed(Player player, int interact)
        {
            ...
            switch (interact)
            {
                ...
                case 59:
                    ...
                    InvInterface.OpenOut(player, Stocks.fracStocks[7].Weapons, "Склад оружия", 6);
                    return;
                case 66:
                    if (Main.Players[player].FractionID != 7)
                    {
        ...
        [RemoteEvent("openRadarCop")]
        public static void openRadarCop(Player sender, params object[] arguments)
        {
            try
            {
                if (!NAPI.Player.IsPlayerInAnyVehicle(sender)) return;
                var vehicle = sender.Vehicle;
                if (NAPI.Data.GetEntityData(vehicle, "ACCESS") == "FRACTION" &&
                    (NAPI.Data.GetEntityData(vehicle, "FRACTION") == 7 || NAPI.Data.GetEntityData(vehicle, "FRACTION") == 18) &&
                    (sender.VehicleSeat == 0 || sender.VehicleSeat == 1))
                {
                    MenuManager.Close(sender);
                    if (Main.Players[sender].FractionID == 7 || Main.Players[sender].FractionID == 18)
                    {
                        Trigger.PlayerEvent(sender, "client::openRadarCop");
                        Commands.RPChat("me", sender, "включил(а) радар");
                    }
                }
                return;
            }
            catch (Exception e) { Log.Write("openRadarCop: " + e.Message, nLog.Type.Error); }
        }
            ...
            try
            {
                switch (index)
                {
                    ...
                    case 2: //smg
                        ...
                        return;
                    case 3: //pumpshotgun
                        Fractions.Manager.giveGun(Player, Weapons.Hash.HeavyShotgun, "PumpShotgun");
                        return;
                    case 4: //stungun
                    ...
                    case 10: // shotgun ammo
                        ...
                        var bItem = nInventory.Find(Main.Players[Player].UUID, ItemType.LSPDDrone);
                        if (bItem != null)
                        {
                            Notify.Send(Player, NotifyType.Error, NotifyPosition.BottomCenter, "У Вас уже есть коптер", 3000);
                            return;
                        }
                        Fractions.Stocks.fracStocks[7].Materials -= Fractions.Manager.matsForArmor;
                        Fractions.Stocks.fracStocks[7].UpdateLabel();
                        nInventory.Add(Player, new nItem(ItemType.LSPDDrone, 1, 100.ToString()));
                        Notify.Send(Player, NotifyType.Success, NotifyPosition.BottomCenter, $"Вы получили коптер", 3000);
                        GameLog.Stock(Main.Players[Player].FractionID, Main.Players[Player].UUID, "drone", 1, false);
                        Manager.FracLogs[Main.Players[Player].FractionID].Add(new List<object> { DateTime.Now.ToString("dd.MM.yyyy"), $"{DateTime.Now.Hour}:{(DateTime.Now.Minute < 10 ? "0" : "")}{DateTime.Now.Minute}", Player.Name, "Коптер", 1, "скрафтил" });
                        return;
                    case 11:
                        if (!Manager.canGetWeapon(Player, "armor")) return;
                        if (Fractions.Stocks.fracStocks[7].Materials < Fractions.Manager.matsForArmor)
                        ...
                        Fractions.Stocks.fracStocks[7].Materials -= Fractions.Manager.matsForArmor;
                        Fractions.Stocks.fracStocks[7].UpdateLabel();
                        nInventory.Add(Player, new nItem(ItemType.WalkieTalkie, 1));
                        Notify.Send(Player, NotifyType.Success, NotifyPosition.BottomCenter, $"Вы получили рацию", 3000);
                        GameLog.Stock(Main.Players[Player].FractionID, Main.Players[Player].UUID, "Walkie", 1, false);
                        return;
