...
namespace NeptuneEVO.Fractions
{
    class Fbi : Script
    {
        ...
        public static Vector3 EnterFBI = new Vector3(107.1693, -744.6852, 30.75476);
        private static Vector3 ExitFBI = new Vector3(107.1693, -744.6852, 30.75476);
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                NAPI.TextLabel.CreateTextLabel("~b~Помощник", new Vector3(149.1317, -758.3485, 243.152), 5f, 0.3f, 0, new Color(255, 255, 255), true, NAPI.GlobalDimension);
                NAPI.TextLabel.CreateTextLabel("~b~SWAT", new Vector3(120.0836, -726.7773, 243.152), 5f, 0.3f, 0, new Color(255, 255, 255), true, NAPI.GlobalDimension);
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~Переодевалка"), new Vector3(fbiCheckpoints[0].X, fbiCheckpoints[0].Y, fbiCheckpoints[0].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~Нажмите Е"), new Vector3(EnterFBI.X, EnterFBI.Y, EnterFBI.Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~Лифт"), new Vector3(ExitFBI.X, ExitFBI.Y, ExitFBI.Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~Лифт"), new Vector3(fbiCheckpoints[1].X, fbiCheckpoints[1].Y, fbiCheckpoints[1].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~Лифт"), new Vector3(fbiCheckpoints[2].X, fbiCheckpoints[2].Y, fbiCheckpoints[2].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~Лифт"), new Vector3(fbiCheckpoints[3].X, fbiCheckpoints[3].Y, fbiCheckpoints[3].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~Лифт"), new Vector3(fbiCheckpoints[4].X, fbiCheckpoints[4].Y, fbiCheckpoints[4].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~Открыть меню оружия"), new Vector3(fbiCheckpoints[5].X, fbiCheckpoints[5].Y, fbiCheckpoints[5].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~Лифт"), new Vector3(fbiCheckpoints[6].X, fbiCheckpoints[6].Y, fbiCheckpoints[6].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~Лифт"), new Vector3(fbiCheckpoints[7].X, fbiCheckpoints[7].Y, fbiCheckpoints[7].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~Переодется в SWAT"), new Vector3(fbiCheckpoints[8].X, fbiCheckpoints[8].Y, fbiCheckpoints[8].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~Открыть склад оружия"), new Vector3(fbiCheckpoints[9].X, fbiCheckpoints[9].Y, fbiCheckpoints[9].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255));
                #endregion
            }
        ...
        public static void interactPressed(Player player, int interact)
        {
            switch (interact)
            {
                ...
                case 61:
                    ...
                    InvInterface.OpenOut(player, Stocks.fracStocks[9].Weapons, "Склад оружия", 6);
                    return;
            }
        }
        ...
        {
            Trigger.PlayerEvent(player, "openlift", 0, "fbilift");
        }
        [RemoteEvent("fbilift")]
        public static void callback_fbilift(Player Player, int floor)
        {
            try
            {
                if (Player.IsInVehicle) return;
        ...
        {
            Trigger.PlayerEvent(player, "fbiguns");
        }
        [RemoteEvent("fbigun")]
            ...
            try
            {
                switch (index)
                {
                    ...
                    case 11:
                        ...
                        if (nInventory.Items[Main.Players[Player].UUID].FirstOrDefault(i => i.Type == ItemType.Jewelry && i.Data == data) != null)
                        {
                            Notify.Send(Player, NotifyType.Error, NotifyPosition.BottomCenter, $"У Вас уже есть бейдж", 3000);
                            return;
                        }

                        var tryAdd = nInventory.TryAdd(Player, new nItem(ItemType.Jewelry));
                        ...
                        nInventory.Add(Player, new nItem(ItemType.Jewelry, 1, data));
                        Notify.Send(Player, NotifyType.Success, NotifyPosition.BottomCenter, $"Вы получили бейдж FIB", 3000);
                        return;
                    case 12: // shotgun ammo
                        if (Fractions.Stocks.fracStocks[9].Materials < Fractions.Manager.matsForArmor)
                        {
