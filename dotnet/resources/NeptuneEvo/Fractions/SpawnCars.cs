    ...
    class SpawnCars : Script
    {
                ...
                switch (id)
                {
                    case 222:
                        ...
                        foreach (var veh in Configs.FractionVehicles[idfrac])
                        {
                            ...
                            item.Add(Utilis.VehiclesName.GetRealVehicleName(Configs.FractionVehiclesNames[veh.Key]));
                            item.Add($"{veh.Key}");
                            items.Add(item);
                        }
        ...
        public static void Event_CallbackSpawnCar(Player player, int key)
        {
            try
            {
                ...
                var vehi = NAPI.Vehicle.CreateVehicle(model, Configs.FractionVehicles[Main.Players[player].FractionID][number].Item2, Configs.FractionVehicles[Main.Players[player].FractionID][number].Item3, veh.Item5, veh.Item6);
                ...
                VehicleStreaming.SetEngineState(vehi, false);
        ...
        internal class SpawnCarPoint
        {
            ...
            public SpawnCarPoint(Vector3 pos, int id)
            {
                ...
                label = NAPI.TextLabel.CreateTextLabel("~w~Транспорт ", new Vector3(pos.X, pos.Y, pos.Z), 20F, 0.5F, 0, new Color(255, 255, 255), true, 0);
