...
namespace NeptuneEVO.Fractions
{
    class Mafia : Script
    {
        ...
        public void Event_ResourceStart()
        {
            ...
            ColShape shape = NAPI.ColShape.CreateCylinderColShape(new Vector3(-1520.0853, 110.177505, 49.2), 1f, 2, 0);
            ...
            NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Крафт оружия"), new Vector3(-1520.0853, 110.177505, 49.2) + new Vector3(0, 0, 0.7), 5F, 0.3F, 0, new Color(255, 255, 255));
            NAPI.Marker.CreateMarker(1, new Vector3(-1520.0853, 110.177505, 49.2) - new Vector3(0, 0, 0.5f), new Vector3(), new Vector3(), 0.965f, new Color(0, 175, 250, 220), false, 0);
            NAPI.Marker.CreateMarker(27, new Vector3(-1520.0853, 110.177505, 49.2) + new Vector3(0, 0, 0.14f), new Vector3(), new Vector3(), 1f, new Color(0, 175, 250, 220), false, 0);
