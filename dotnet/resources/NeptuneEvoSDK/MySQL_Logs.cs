...
{
    public static class MySQL_Logs
    {
       // private static Config config = new Config("MySQL");
        ...
        #region Settings
        public static string _dbHost = "127.0.0.1";
        public static string _dbUser = "root";
        public static string _dbPassword = "root";
        public static string _dbName = "freedomlogs";
        public static string _dbSslMode = "None";
        #endregion
