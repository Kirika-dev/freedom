...
var lastButSlots = 0;
mp.events.add('CharacterCreatorName', () => {
    editorBrowser = mp.browsers.new('http://package/interface/character.html');
    editorBrowser.execute(`editor.activeName=true`)
});

mp.events.add('createnewchar', (name, lastname) => {
    ...
    mp.events.callRemote('newchar', 1, name, lastname);
});
...
mp.events.add('CreatorCamera', async () => {
    mp.game.cam.doScreenFadeOut(1);
    ...
    var camValues = { Angle: localplayer.getRotation(2).z + 90, Dist: 0.6, Height: 0.2 };
...
//    mp.game.cam.renderScriptCams(true, false, 500, true, false);
    cameraRotator.start(bodyCam, new mp.Vector3(bodyCamStart.x, bodyCamStart.y, bodyCamStart.z + camValues.Height + 0.3), new mp.Vector3(bodyCamStart.x, bodyCamStart.y, bodyCamStart.z + camValues.Height+ 0.3), new mp.Vector3(-0.6, 0.6, 0), 90);
    cameraRotator.setZBound(0, 0);
    ...
    if(editorBrowser == null) editorBrowser = mp.browsers.new('http://package/interface/character.html#content-1');
    editorBrowser.execute(`editor.activeName = false`)
