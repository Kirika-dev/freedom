...
mp.game.streaming.removeIpl("sf_dlc_fixer_hanger_door");
mp.game.streaming.removeIpl("sf_dlc_fixer_hanger_door_lod");
mp.game.streaming.removeIpl("sf_musicrooftop");
mp.game.streaming.removeIpl("sf_phones");
mp.game.streaming.removeIpl("sf_franklin");
mp.game.streaming.removeIpl("sf_mansionroof");
mp.game.streaming.removeIpl("sf_plaque_hw1_08");
mp.game.streaming.removeIpl("sf_plaque_bh1_05");
mp.game.streaming.removeIpl("sf_plaque_kt1_08");
mp.game.streaming.removeIpl("sf_plaque_kt1_05");
mp.game.streaming.removeIpl("sf_fixeroffice_bh1_05");
mp.game.streaming.removeIpl("sf_fixeroffice_kt1_05");
mp.game.streaming.removeIpl("sf_fixeroffice_hw1_08");
...
// let agINT = mp.game.interior.getInteriorAtCoords(-1070.000, -70.000, -100.000);
// let agProps = [
...
// ];
// for (const propName of agProps) {
    // mp.game.interior.enableInteriorProp(agINT, propName);
// }

let carmeetInt = mp.game.interior.getInteriorAtCoords(-2000.0, 1113.211, -25.36243);
let cmProps = [
...
for (const propName of cmProps) {
    mp.game.interior.enableInteriorProp(carmeetInt, propName);
}

let msINT = mp.game.interior.getInteriorAtCoords(-1010.000, -70.000, -100.000);
let msProps = [
...
for (const propName of msProps) {
    mp.game.interior.enableInteriorProp(msINT, propName);
}
