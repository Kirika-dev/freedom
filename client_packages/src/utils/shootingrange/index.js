...
mp.events.add("StartPoligon", () => {
    ...
    targetleft = 45;
    points = 0;
	poligonpointsmenu = mp.browsers.new("http://package/interface/modules/Poligon/index.html");
...
mp.events.add("StopPoligon", () => {
	...
	target = null;
	cCoords = null;
	poligonpointsmenu.active = false
	isStarted = false;
});
...
mp.events.add('OpenPedPoligon', function(lvl) {
	poligonpedmenu = mp.browsers.new("http://package/interface/modules/Poligon/PedMenu/index.html");
