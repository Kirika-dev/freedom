const vehheading = require("./src/utils/VehicleRotator.js");
var lsc = mp.browsers.new('http://package/interface/tuningauto/home.html');
lsc.active = false;
var lscSpeed = 0;
var lscBrakes = 0;
var lscBoost = 0;
...
setTimeout(function () { lsc.active = false; lsc.execute(`show(${false});`); }, 1500);
...
mp.events.add('tclk', (id) => {
    ...
    if (setted)
        ...
        var title = (lscPage === "paint_menu_one" || lscPage === "paint_menu_two" || lscPage === "paint_menu_three") ? "Покрасить машину?" : "Установить данную модификацию?";
