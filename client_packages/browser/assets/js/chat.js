...
$(document).ready(function () {
    ...
    $("body").keydown(function (event) {
        if (event.which == 84 && chat.input == null && chat.active == true) {
            ...
            var value = chat.input.children("input").val().replace(/(негр|пидр|нигрила|пидарас|пидор|пидорас|ниггер|нигрила|ниггрила|педик|пидарасина|нигга|негар|неггар|пидераст|majestic|grand|маджестик|гранд|маджестикрп|грандрп|редага|redage|дедстар|аризона|аризону|arizona|majesticrp|pidr|nigger|nigga|niger|pidaras|pidrila|pedik|pidoras|pidr|negr|мажесик|majestik|majestike|аризоне|arizone|гранде|grande|дедстаре|шлюха|радмир|радмире|radmir|радмиру|fivelive|dednet|деднете|деднет|даун)/gi,()=>["кактус","лабрадудель","красавчик","пуфик","кирпич","фундук","крот","лаванда","кринж","цемент"][Math.floor(10*Math.random())]);
