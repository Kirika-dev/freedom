...
function enableChatInput(enable) {
    ...
    if (enable != (chat.input != null)) {
        ...
        if (enable) {
            ...
            chat.input = chatvar.append('<div class="qwe"><textarea type="text" id="chat_msg" placeholder="Начните писать сообщение..."></textarea><button class="img"></div>').children(":last");
