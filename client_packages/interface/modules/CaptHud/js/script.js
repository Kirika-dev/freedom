const wrapper = new Vue({
    ...
    data:{
        ...
        band1Name: ["Marabuchanta Grande", "fraction1"],
        band2Name: ["The Ballas", "fraction4"],
        band1Kils: 7,
        band2Kils: 5,
        time: '02:51',
    ...
    methods:{
        addKills: function(json){
			json = JSON.parse(json)
            if (json.weapon in causes) {
              json.weapon = causes[json.weapon];
			  json.weapon = json.weapon.replace(" ","_");
            }
            this.kills.push(json);
        },
		...
		{
			this.band1Name = [a, BandColours[a]]
			this.band2Name = [b, BandColours[b]]
			this.active = true
			updatekills(c,d)
			updatetime(e,f)
		}
...
var BandColours = {
	"The Families": "fraction1",
	"The Ballas Gang": "fraction2",
	"Los Santos Vagos": "fraction3",
	"Marabunta Grande": "fraction4",
	"Blood Street": "fraction5",
}
function cheker(){
